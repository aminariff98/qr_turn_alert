                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(
                              'Queuing: $QueueWaitingInvestment',
                              style: TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.bold,
                              ),
              ...
              Padding(
                ...
                child: Material(
                    ...
                    child: FlatButton(
                        ...
                        onPressed: () {
                          startTimer();
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => QueueDetails()));
                          dailySpecialRef
                              .set({'description': 'Test', 'price': 'Test'})
