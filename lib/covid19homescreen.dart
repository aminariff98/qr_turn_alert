  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            icon: Icon(Icons.radio_button_off_rounded, color: kPrimaryColor, size: 10,),
            padding: const EdgeInsets.only(right: 15),
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => PreQueuePage()),
                //QueueDetails()),
      ...
      decoration: BoxDecoration(
        ...
        children: <Widget>[
          ...
          Text("Welcome to VQueue.",  style: const TextStyle(
              color: Colors.white,
              fontSize: 15,
              fontWeight:
              FontWeight.bold)),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    Row(children: <Widget>[
                      Text("Experience virtual queuing",
                          style: const TextStyle(
                              color: Colors.white,
                              fontSize: 18,
                              fontWeight:
                    ...
                    SizedBox(height: screenHeight * 0.02),
                    Text("Be part of the queue without your physical presence. Easily scan the QR code and start queuing.",  style: const TextStyle(
                        color: Colors.white,
                        fontSize: 12,
                        fontWeight:
                        FontWeight.bold)),
          ...
          Container(
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    Row(children: <Widget>[
                      Text("Received all the latest details",
                          style: const TextStyle(
                              color: Colors.white,
                              fontSize: 18,
                              fontWeight:
                    ...
                    SizedBox(height: screenHeight * 0.02),
                    Text("Get all the latest queuing details from your phone while you're away.",  style: const TextStyle(
                        color: Colors.white,
                        fontSize: 12,
                        fontWeight:
                        FontWeight.bold)),
          ...
          Padding(
            ...
            child: Material(
                ...
                child: FlatButton(
                    ...
                    child: Text("Click here to queue", style: const TextStyle(
    color: Colors.white,)),
                    onPressed: () async{
                      ...
                      if (qrResult == scanning) {
                        print("Hello");
                        Navigator.push(
                          context, MaterialPageRoute(builder: (context) => PreQueuePage()),
                        );
                      }
                    },
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Container(child: Text("Click here to begin scanning",
        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  Text("                  Maybank Suria KLCC", textAlign: TextAlign.center, style: const TextStyle(
                      color: Colors.black,
                      fontSize: 20,
                      fontWeight:
                      FontWeight.bold))
