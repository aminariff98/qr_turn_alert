...
class _HomeScreen1State extends State<HomeScreen1> {
  ...
  void initState() {
    super.initState();
    EasyLoading.dismiss();
    userModel = FirebaseUserController().getUser('gPzA2xQr1EfSMj5syLeGGTsC1ok2');
    userModel.then((data) {
      print('test 123');
    });

    // print(FirebaseUserController.getUser('gPzA2xQr1EfSMj5syLeGGTsC1ok2').toString());
  }
